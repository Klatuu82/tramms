              ...
              <div class="card-stacked">
                <div class="card-content">
                  <div class="card-content" style="padding:20px;">
                        ...
                        <div class="message">
                          <?php echo "Styles make the formatting job much easierStyles make the formatting job much easierStyles make the formatting job much easierStyles make the formatting job much easier" ?>
